    ...
    <RealEstate_Database>
      ...
      <Properties>
        <xsl:for-each select="Properties">
          ...
          <xsl:variable name="landlord" select="../LandLordInformations[PropertyID=$currentPropertyID]"/>
          <xsl:variable name="agent" select="../RealEstateAgent[PropertyID=$currentPropertyID]"/>
